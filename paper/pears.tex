...
\newcommand{\gb}[1]{\textcolor{yellow}{\textbf{g: #1}} }
...
\begin{table*}[]
  ...
  \begin{figure*}[htb]
    ...
    \caption{Median number of dwarf and massive primaries and pairs per abundance matching realization as a function of redshift, with shaded regions showing the $1^{\rm st}$ and 99$^{\rm th}$ percentiles. The number of dwarf and massive primaries peaks around $z=1$, and there are fewer primaries and pairs at higher redshift, and . The evolution of the number of primaries is roughly similar between dwarf and massive galaxies, though the number of dwarf primaries drops steeply from $z=1$ to $z=0$. The number of dwarf pairs peaks around $z=2$, while the number of massive pairs increases nearly monotonically from $z=4-0$. There are approximately 8 times as many dwarf primaries as massive primaries. 
      }
    \label{fig:counts}
  \end{figure*}
...
\begin{figure*}[htb]
  ...
  Also note than many of the close pairs at high z may merge by $z=0$. \kc{add median line to plot}
    }
  \label{fig:sep-dist}
\end{figure*}
