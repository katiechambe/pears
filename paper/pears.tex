...
\begin{abstract} 
    Low mass galaxy pair fractions are under-studied across cosmic time. \add{Further, it is unclear whether low mass pair fractions evolve in the same way as more massive systems over cosmic time.}
    ...
    \add{We use the Illustris TNG100 simulation to create a sample of physically associated pairs between $z=0-4.2$, including low mass ($\rm 10^8<M_*<5\times10^9\,\Msun$) and high mass ($\rm 5\times10^9<M_*<10^{11}\,\Msun$) isolated subhalo pairs.}
