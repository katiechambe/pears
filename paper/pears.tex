...
% Sec.~\ref{sec:methods-am} explains the abundance matching prescription used to associate stellar masses with the dark matter subhalos.
...
\subsection{Simulation details} \label{sec:methods-sims}
    \begin{itemize}
        \item What do we require in a sim/why using TNG hydro?
        \item Brief sim details \& and the data we use (group and merger cats)
    \end{itemize}
