...
\begin{figure*}[htp]
  ...
  Minor dwarf pairs tend to be $\sim10-20\kpc$ closer to their primary than major dwarf pairs, while minor massive pairs are between $10-50\kpc$ closer than major pairs. \todo{remove "difference" legend, explain in capt. what "Maj-Min" means}
    }
  \label{fig:sep}
\end{figure*}
...
\begin{figure*}[htp]
  ...
  \todo{finish caption} \todo{remove "difference" legend, explain in capt. what "Ma-Dw" means}
  ...
  \todo{finish caption} \todo{remove "difference" legend, explain in capt. what "Maj-Min" means}
    }
  \label{fig:scaled}
\end{figure*}
